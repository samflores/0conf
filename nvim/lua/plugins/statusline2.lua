local config = function()
  ...
  local colors     = {
    bright_bg = utils.get_highlight("Normal").bg or '#000000',
  ...
  local Align = { provider = "%=", hl = { fg = "bright_bg", bg = "bright_bg" } }
  local Space = { provider = " ", hl = { fg = "bright_bg", bg = "bright_bg" } }
  ViMode = utils.surround({ "", "" }, "bright_fg", { ViMode })
