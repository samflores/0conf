local package = 'dsych/galaxyline.nvim'
local dependencies = {
  'kyazdani42/nvim-web-devicons',
}
local branch = 'bugfix/diagnostics'
...
local config = function()
  ...
  local mode_map = {
    n      = { icons.normal .. " ", colors.red },
    no     = { icons.normal .. " ", colors.red },
    i      = { icons.insert .. " ", colors.green },
    ic     = { icons.insert .. " ", colors.green },
    c      = { icons.command .. " ", colors.orange },
    ce     = { icons.command .. " ", colors.orange },
    cv     = { icons.command .. " ", colors.orange },
    v      = { icons.visual .. " ", colors.lightblue },
    V      = { icons.visual .. " ", colors.lightblue },
    [""]  = { icons.visual .. " " .. icons.visual_block .. " ", colors.brown },
    R      = { icons.replace .. " ", colors.crimsonRed2 },
    ['r?'] = { icons.replace .. " ", colors.lightblue },
    Rv     = { icons.replace .. " ", colors.crimsonRed2 },
    r      = { icons.replace .. " ", colors.blue2 },
    rm     = { icons.replace .. " ", colors.blue2 },
    s      = { icons.selection .. " ", colors.greenYelenYel },
    S      = { icons.selection .. " ", colors.greenYelenYel },
    ['']  = { icons.selection .. " ", colors.greenYelenYel },
    t      = { icons.terminal .. " ", colors.magenta },
    ['!']  = { "  !        ", colors.crimsonRed }
  }
  ...
  local function file_name(is_active, highlight_group)
    ...
    local modified_fg = is_active and colors.red or "#cc8800"
